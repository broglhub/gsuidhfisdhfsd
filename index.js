...
var ruleschannel = client.channels.get('714862522385170472')
	...
	.setFooter("Made by Chaotic Mind#0666", "https://cdn.discordapp.com/avatars/655714844695330854/a_ac9969af8c3d41eeac55fc134b0412a4.gif?size=2048")
	.setThumbnail("https://cdn.discordapp.com/avatars/714874905669402634/b538a848a7825a2d5ee1bae150c241a4.png?size=2048")
	.addField("Spamming", "Don't spam. spamming will result into mutes or further punishments.", true)
	.addField("NSFW content", "Do not post any animal abuse videos, child abuse, gore in any channels. no nsfw outside the nsfw channel", true)
	.addField("Voice and audio", "do not post any loud / earrape audios as well as playing earrapes on voicechat.", true)
	.addField("personal information", "Do not give out any personal information about anyone", true)
	.addField("reporting", "do not post any fake reports. reporting itself can be done in the user reports channel.", true)
	.addField("Advertising", "Do not advertise anything offtopic (exploits, server invites etc etc)", true)
	.addField("raiding", "do not attempt to raid the server.", true)
	.addField("leaking/cracking", "do not attempt to leak or crack the script or it will result into a temporary downtime with new methods", true)
	.addField("mentioning", "do not ghostping or mass ping, don't ping roles if it's not neccessary", true)
	.addField("Flooding", "same as spamming, do not flood the chat. keep the message sizes normal.", true)
